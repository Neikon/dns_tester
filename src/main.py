...
class DnsTesterApplication(Adw.Application):
    """The main application singleton class."""

    def __init__(self):
        super().__init__(application_id='es.neikon.dns_tester',
    ...
    def do_activate(self):
        ...
        if not win:
            win = DnsTesterWindow(application=self)
        win.present()
